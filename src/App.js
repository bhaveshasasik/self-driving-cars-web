  ...
  return (
    ...
    <main className="w-full h-full">
              ...
              <div className="w-full h-auto max-w-5xl p-10 mx-auto">
                ...
                <div className="space-y-4">
                  <p className='font-DMSans text-xl md:text-2xl lg:text-3xl text-white'>
                    ...
                    impacts. Majority of self-driving vehicles are EVs. This is because electric vehicles have stable power and low latency. Demand for lithium and nickle to manufacture EV batteries will increase by 4000%
      ...
      <div className='bg-future-background bg-cover bg-center h-screen relative'>
        <h1 className="font-DMSans font-medium text-4xl md:text-5xl lg:text-6xl xl:text-8xl text-center text-white p-10 md:p-20 lg:p-32 xl:p-40"></h1>
        <div className="flex space-x-5 absolute bottom-32 left-1/2 transform -translate-x-1/2">
          <Popup 
